package traineeship_manager.config;
...
import traineeship_manager.config.CustomSecuritySuccessHandler;
import traineeship_manager.services.UserServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                http.authorizeHttpRequests(
                        ...
                        .requestMatchers("/committee/**").hasAuthority("Committee") // ??? ZAS is this needed ??? - changed from account to user
